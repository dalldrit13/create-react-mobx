...
# Getting Started
Make sure npm and node are installed<br>
*For Reference the version of npm and node used to author this template*<br>
_(npm -v -> 8.19.2)_<br>
_(node -v -> 18.12.1)_

Once you have finished initialization you can delete the init folder
